<template>
  <div>
    ...
    <Nuxt />
    <footer class='text-sm text-gray-600 my-20 px-12 text-center'>
      &copy;{{ currentDate.getFullYear() }} {{ heading }}<br>
      Made with
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class='fill-current w-4 h-4 mx-px inline-block'>
